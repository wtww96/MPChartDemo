...
public class BarChart extends BarLineChartBase<BarData> implements BarDataProvider {
     ...
     * 是否绘制圆角矩形柱状图
     */
    private float barRoundedRadius = 0f;
     ...
     */
    @Override
    public float isDrawBarRoundedRadius() {
        return barRoundedRadius;
    }
     ...
     * 圆角半径 0:非圆角   大于0:圆角
     */
    public void setDrawBarRoundedRadius(float radius) {
        barRoundedRadius = radius;
    }
